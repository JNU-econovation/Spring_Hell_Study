...
public class GoodsApp {
    public static void main(String[] args) {
        ...
        BaseGoods goods1 = new NamwonGoods(1L,"남원 두마리 양념치킨 스티커",200,1000);
        BaseGoods goods2 = new NamwonGoods(2L,"남원 스타벅스 창립 기념 스티커",200,1000);
        BaseGoods goods3 = new NamwonGoods(3L,"남원시 인구 75000명 달성 기념 스티커",200,1000);
        BaseGoods goods4 = new NamwonGoods(4L,"남원시 정당 선호 조사 기념 스티커",200,1000);
        BaseGoods goods5 = new NamwonGoods(5L,"남원 양림단지 붕어 단체 사망 기념 스티커",200,1000);
        BaseGoods goods6 = new NamwonGoods(6L,"남원 지리산 애기봉 완봉 스티커",200,1000);
